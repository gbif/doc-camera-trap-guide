= Best Practices for Managing and Publishing Camera Trap Data: Community Review DRAFT
:authorcount: 3
...
:title-page-background-image: image:img/doc-camtrap-illustration.svg[position=top center]
...
:observations-taxonID: link:https://camtrap-dp.tdwg.org/data/#observations.taxonID[observations.taxonID,role=term]
