...
* Data exchange is now facilitated by Camera Trap Data Package (https://camtrap-dp.tdwg.org/[Camtrap DP]), a <<data-exchange-format,data exchange format>> developed under Biodiversity Information Standards (https://www.tdwg.org/[TDWG]). There is increased awareness of open science, <<FAIR>> data cite:[wilkinson-2016] and privacy regulations
