...
(<<metadata, Project metadata>>,#chapter_project_metadata, #chapter_media, #chapter_deployments, #chapter_observations), we focus on how to best manage these, and what data management platforms you can use to facilitate you in doing so.
