...
[[table-deployment]]
.Recorded information for the deployment that generated the image in <<figure-example-image>>. Source: https://tdwg.github.io/camtrap-dp/example/00a2c20d-f038-490c-9b3f-7e32abfa0be7/
[%header,cols=2*]
|===
|Property
|Value
...
[[table-observation]]
.Recorded information for one of the observations that is based on the image in <<figure-example-image>>. It is classified at event level (sequence) in the camera trap management system Agouti. Source: https://tdwg.github.io/camtrap-dp/example/00a2c20d-f038-490c-9b3f-7e32abfa0be7/#79204343-27df-401d-bfbd-80366e848fd5
[%header,cols=2*]
|===
|Property
|Value
