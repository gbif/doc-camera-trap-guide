...
* Avoid including units and data types. Describe these elsewhere (e.g. in a separate sheet, README document or https://specs.frictionlessdata.io/table-schema/[Table Schema]), together with the column definition and controlled values (see <<table-readme>>).
* Be consistent.
...
[#table-readme]
.Example of how to describe deployment data in a separate spreadsheet.
[%header,cols=6*]
|===
|Column name
|Definition
