...
Data management is one of the real bottlenecks in camera trap research. 
...
In this section, we introduce a number of general conventions for sound data management data. 
