...
[[camtrap-dp]]Camtrap DP:: TODO See also <<section-camtrap-dp>>.
...
[[event]]event:: TODO Mention sequence. Can be indicated with {observations-eventID} in Camtrap DP.
...
[[observation-type]]observation type:: TODO {observations-observationType} in Camtrap DP.
